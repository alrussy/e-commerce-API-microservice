...
public interface SkuProductRepository extends JpaRepository<SkuProduct, String>, JpaSpecificationExecutor<SkuProduct> {
     ...
     */
    @EntityGraph(attributePaths = {"details"})
    List<SkuProduct> findByProductIdCategoryIdAndIsPrimaryTrue(long categoryId);
    ...
    Page<SkuProduct> findAllByIsPrimaryAndProductSkuCodeIn(Pageable page, boolean b, List<String> skuCodes);
