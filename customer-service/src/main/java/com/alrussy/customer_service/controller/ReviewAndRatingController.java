...
import com.alrussy.customer_service.dto.ReviewAndRatingRequest;
import com.alrussy.customer_service.dto.ReviewAndRatingResponse;
import com.alrussy.customer_service.dto.ReviewAndRatingWithCountAndAvrgRating;
...
public class ReviewAndRatingController {
	...
	public ResponseEntity<ReviewAndRating> findByUsernameAndSkuCode(@RequestParam String username,@RequestParam String skuCode) {
	...
	public ResponseEntity<Page<ReviewAndRating>> findReviewsAndRatingsBySkuCode(@PathVariable String skuCode,@RequestParam Integer pageNumber,@RequestParam Integer pageSize ) {
